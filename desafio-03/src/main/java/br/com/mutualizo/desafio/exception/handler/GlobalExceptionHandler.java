...
import static br.com.mutualizo.desafio.util.ConstantesUtil.*;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleMotivoNaoAlteradoException(ProdutoNaoEncontradoException ex, WebRequest request) {
